...
#define MOTOR_UP_PIN   PIN_G0 // Define the pin for Motor Up control
#define MOTOR_DOWN_PIN PIN_G1 // Define the pin for Motor Down control
#define DOOR_OPEN_PIN  PIN_F4 // Define the pin for Door simulation
